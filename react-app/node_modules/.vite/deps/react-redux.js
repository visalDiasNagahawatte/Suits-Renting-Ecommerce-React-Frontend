...
import {
  require_prop_types,
  require_react_is
} from "./chunk-EFSSZ6D3.js";
import "./chunk-G3OTJKEK.js";
import {
  require_react_dom
...
function connectAdvanced(selectorFactory, _ref) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    var usePureOnlyMemo = pure ? import_react2.useMemo : function(callback) {
      return callback();
    };
    function ConnectFunction(props) {
      ...
      var ContextToUse = (0, import_react2.useMemo)(function() {
        return propsContext && propsContext.Consumer && (0, import_react_is.isContextConsumer)(import_react2.default.createElement(propsContext.Consumer, null)) ? propsContext : Context;
      }, [propsContext, Context]);
      var contextValue = (0, import_react2.useContext)(ContextToUse);
      ...
      var childPropsSelector = (0, import_react2.useMemo)(function() {
        return createChildSelector(store);
      }, [store]);
      var _useMemo2 = (0, import_react2.useMemo)(function() {
        if (!shouldHandleStateChanges)
      ...
      var overriddenContextValue = (0, import_react2.useMemo)(function() {
      ...
      var _useReducer = (0, import_react2.useReducer)(storeStateUpdatesReducer, EMPTY_ARRAY, initStateUpdates), _useReducer$ = _useReducer[0], previousStateUpdateResult = _useReducer$[0], forceComponentUpdateDispatch = _useReducer[1];
      if (previousStateUpdateResult && previousStateUpdateResult.error) {
        throw previousStateUpdateResult.error;
      }
      var lastChildProps = (0, import_react2.useRef)();
      var lastWrapperProps = (0, import_react2.useRef)(wrapperProps);
      var childPropsFromStoreUpdate = (0, import_react2.useRef)();
      var renderIsScheduled = (0, import_react2.useRef)(false);
      ...
      var renderedWrappedComponent = (0, import_react2.useMemo)(function() {
        return import_react2.default.createElement(WrappedComponent, _extends({}, actualChildProps, {
          ref: reactReduxForwardedRef
        }));
      }, [reactReduxForwardedRef, WrappedComponent, actualChildProps]);
      var renderedChild = (0, import_react2.useMemo)(function() {
        if (shouldHandleStateChanges) {
    ...
    var Connect = pure ? import_react2.default.memo(ConnectFunction) : ConnectFunction;
    Connect.WrappedComponent = WrappedComponent;
    Connect.displayName = ConnectFunction.displayName = displayName;
    if (forwardRef) {
      var forwarded = import_react2.default.forwardRef(function forwardConnectRef(props, ref) {
